 ...
 * @author <a href="mailto:riccardo.bruno@ct.infn.it">Riccardo Bruno</a>(COMETA)
 */
public class mi_custom_portlet extends GenericPortlet {        
    
    // Instantiate the logger object
    AppLogger _log = new AppLogger(mi_custom_portlet.class);
    ...
    */
    ...
    void submitJob(AppInput appInput) {         
        ...
        if(infrastructuresInfo.length > 0) {            
            ...
            String outputFile="mi-custom-Output.txt";           // Distributed application standard output
            String errorFile ="mi-custom-Output.txt";            // Distrubuted application standard error
            String appFile   ="mi-custom-Files.tar.gz";         // Hostname output files (created by the pilot script)
